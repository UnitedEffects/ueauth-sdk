 ...
 */
/**
 * Send a unique email address and choose email, sms or both for the reset link to be sent. Email must already be associated to the account. If no preference is picked, all associated data is used. This must be associated with the AuthGroup in the url.
 * @export
...
export interface PasswordReset {
     ...
     * @memberof PasswordReset
     */
    formats?: Array<PasswordResetFormatsEnum>;
}
...
/**
    ...
    * @enum {string}
    */
export enum PasswordResetFormatsEnum {
    Email = 'email',
    Sms = 'sms'
}
