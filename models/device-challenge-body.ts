 ...
 */
export interface DeviceChallengeBody {
    /**
     * an email, username, or phone number
     * @type {string}
     * @memberof DeviceChallengeBody
     */
    lookup?: string;
    /**
     * a previously saved state session to ensure this endpoint is not abused
     * @type {string}
     * @memberof DeviceChallengeBody
     */
    state?: string;
