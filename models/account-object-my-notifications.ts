 ...
 * 
 * @export
 * @interface AccountObjectMyNotifications
 */
export interface AccountObjectMyNotifications {
    /**
     * You can silence device notifications for profile requests
     * @type {boolean}
     * @memberof AccountObjectMyNotifications
     */
