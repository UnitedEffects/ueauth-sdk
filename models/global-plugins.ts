 ...
 */
import { GlobalPluginsEventStream } from './global-plugins-event-stream';
import { GlobalPluginsMfaChallenge } from './global-plugins-mfa-challenge';
import { GlobalPluginsNotifications } from './global-plugins-notifications';
/**
 * 
 * @export
 * @interface GlobalPlugins
 */
export interface GlobalPlugins {
    /**
     * 
     * @type {string}
     * @memberof GlobalPlugins
     */
    id?: string;
    /**
     * 
    ...
    createdAt?: Date;
    /**
     * User Id of the person who created latest update config
     * @type {string}
     * @memberof GlobalPlugins
     */
    createdBy?: string;
    /**
     * 
     * @type {GlobalPluginsNotifications}
     * @memberof GlobalPlugins
     */
    notifications?: GlobalPluginsNotifications;
    /**
     * 
     * @type {GlobalPluginsEventStream}
     * @memberof GlobalPlugins
     */
    eventStream?: GlobalPluginsEventStream;
    /**
     * 
     * @type {GlobalPluginsMfaChallenge}
     * @memberof GlobalPlugins
     */
    mfaChallenge?: GlobalPluginsMfaChallenge;
}
