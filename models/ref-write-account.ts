 ...
 * 
 * @export
 * @interface RefWriteAccount
 */
export interface RefWriteAccount {
    /**
     * optional identifier, must be unique in the authGroup. If not provided, set to email.
     * @type {string}
     * @memberof RefWriteAccount
     */
    username?: string;
    /**
     * email address
    ...
    /**
     * 
     * @type {RefWriteAccountPhone}
     * @memberof RefWriteAccount
     */
    phone?: RefWriteAccountPhone;
    /**
     * additional context provided by the implementer.
     * @type {any}
     * @memberof RefWriteAccount
     */
    metadata?: any;
