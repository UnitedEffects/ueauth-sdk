 ...
 */
import { RefSecuredProfileWrite } from './ref-secured-profile-write';
 ...
 * 
 * @export
 * @interface SecuredProfileWrite
 */
export interface SecuredProfileWrite extends RefSecuredProfileWrite {
    /**
     * user ID
     * @type {string}
     * @memberof SecuredProfileWrite
     */
    accountId: string;
}
