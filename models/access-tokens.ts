...
export interface AccessTokens {
    /**
     * this is an access_token and is primarily used for API access
     * @type {string}
    ...
    expiresIn?: number;
    /**
     * this is an id_token and is primarily used to idenitify a user via claims, not for use with APIs
     * @type {string}
     * @memberof AccessTokens
     */
    idToken?: string;
    /**
     * requested scopes delimited by spaces
     * @type {string}
     * @memberof AccessTokens
     */
    scope?: string;
