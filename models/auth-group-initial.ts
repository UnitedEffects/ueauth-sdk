 ...
 * 
 * @export
 * @interface AuthGroupInitial
 */
export interface AuthGroupInitial extends AuthGroup {
    /**
     * when this auth group will expire if it is not connected to the owner account and activated
     * @type {Date}
     * @memberof AuthGroupInitial
     */
    securityExpiration?: Date;
    /**
     * bearer token to use when first connecting an account
     * @type {string}
     * @memberof AuthGroupInitial
     */
