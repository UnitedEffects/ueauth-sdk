 ...
 */
import { AccountObjectMfa } from './account-object-mfa';
import { AccountObjectMyNotifications } from './account-object-my-notifications';
import { RefWriteAccount } from './ref-write-account';
import { RefWriteAccountPhone } from './ref-write-account-phone';
/**
 * 
 * @export
 * @interface AccountObject
 */
export interface AccountObject extends RefWriteAccount {
    /**
    ...
    modifiedBy?: string;
    /**
     * group ID for this account. email addresses are unique to auth groups.
     * @type {string}
     * @memberof AccountObject
     */
    authGroup?: string;
    /**
     * whether or not the account was verified
     * @type {boolean}
     * @memberof AccountObject
     */
    verified?: boolean;
    /**
     * root level block of the user from access to the authGroup
     * @type {boolean}
     * @memberof AccountObject
     */
    blocked?: boolean;
    /**
     * 
     * @type {AccountObjectMfa}
     * @memberof AccountObject
     */
    mfa?: AccountObjectMfa;
    /**
     * 
     * @type {boolean}
     * @memberof AccountObject
     */
    acceptingProfileRequests?: boolean;
    /**
     * 
     * @type {AccountObjectMyNotifications}
     * @memberof AccountObject
     */
    myNotifications?: AccountObjectMyNotifications;
    /**
