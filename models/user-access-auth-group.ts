 ...
 * 
 * @export
 * @interface UserAccessAuthGroup
 */
export interface UserAccessAuthGroup {
    /**
     * 
     * @type {string}
     * @memberof UserAccessAuthGroup
     */
    id?: string;
    /**
     * if true, this person owns the authgroup
     * @type {boolean}
     * @memberof UserAccessAuthGroup
     */
    owner?: boolean;
    /**
     * if true, this person belongs to this authgroup - expect this to usually be true
     * @type {boolean}
     * @memberof UserAccessAuthGroup
     */
    member?: boolean;
