...
export interface Role {
    ...
    id?: string;
    /**
     * this is a small 10 char id unique to authgroup/product that can be used in place of id
     * @type {string}
     * @memberof Role
     */
    codedId?: string;
    ...
    product?: string;
    /**
     * this is the codedId of the product
     * @type {string}
     * @memberof Role
     */
    ...
    custom?: boolean;
    /**
     * organization this role is associated to if this is custom
     * @type {string}
     * @memberof Role
     */
    organization?: string;
