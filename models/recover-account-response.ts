 ...
 */
import { AccountPlusCodes } from './account-plus-codes';
/**
 * 
 * @export
...
export interface RecoverAccountResponse {
     ...
     * 
     * @type {string}
     * @memberof RecoverAccountResponse
     */
    type?: RecoverAccountResponseTypeEnum;
    /**
     * 
     * @type {AccountPlusCodes}
     * @memberof RecoverAccountResponse
     */
    data?: AccountPlusCodes;
}
...
/**
    ...
    * @enum {string}
    */
export enum RecoverAccountResponseTypeEnum {
    Account = 'Account'
}
