 ...
 */
import { WriteProfileRequest } from './write-profile-request';
/**
 * Requests expire after 7 days
 * @export
 * @interface ProfileRequest
 */
export interface ProfileRequest extends WriteProfileRequest {
    /**
     * 
     * @type {string}
    ...
    /**
     * the ID of the Account holder you are request profile data from
     * @type {string}
     * @memberof ProfileRequest
     */
...
/**
    ...
    * @enum {string}
    */
export enum ProfileRequestStateEnum {
    New = 'new',
    Approved = 'approved',
    Denied = 'denied'
}
