 ...
 */
import { SsoSamlSpec } from './sso-saml-spec';
/**
 * 
 * @export
 * @interface FederatedSAML
 */
export interface FederatedSAML extends SsoSamlSpec {
    /**
     * is this a social provider like google or a custom OP you're connecting to?
     * @type {string}
     * @memberof FederatedSAML
     */
    provider: FederatedSAMLProviderEnum;
    /**
     ...
     * @memberof FederatedSAML
     */
    buttonType?: FederatedSAMLButtonTypeEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FederatedSAMLProviderEnum {
    Google = 'google',
    Microsoft = 'microsoft',
    Custom = 'custom'
}
/**
    ...
    * @enum {string}
    */
export enum FederatedSAMLButtonTypeEnum {
    Google = 'google',
    Microsoft = 'microsoft',
    Standard = 'standard'
}
