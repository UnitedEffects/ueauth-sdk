 ...
 */
/**
 * you can use profile data to initilize an organization profile for this Account
 * @export
 * @interface WriteAccountByOrgProfile
 */
export interface WriteAccountByOrgProfile {
    /**
     * used to associate this Organization User to an internal record of the user in an HCM or other system
     * @type {string}
     * @memberof WriteAccountByOrgProfile
     */
    externalId?: string;
}
