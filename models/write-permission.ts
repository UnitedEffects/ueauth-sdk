...
export interface WritePermission {
    /**
     * the target in the system to which an action is attributed
     * @type {string}
     * @memberof WritePermission
     */
    target: string;
    /**
    ...
    action: string;
    /**
     * if true, this means the action is only possible on the target if the target is owned by the user
     * @type {boolean}
     * @memberof WritePermission
     */
    ownershipRequired?: boolean;
    /**
     * something to present on the screen explaining what this is for
     * @type {string}
     * @memberof WritePermission
     */
    description?: string;
    /**
     * descriptive labels to aid in search and general categorization
     * @type {Array<string>}
     * @memberof WritePermission
     */
    tags?: Array<string>;
