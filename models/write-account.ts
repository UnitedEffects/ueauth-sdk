...
import { WriteAccountProfile } from './write-account-profile';
import { WriteAccountProfileProfile } from './write-account-profile-profile';
/**
 * 
 * @export
 * @interface WriteAccount
 */
export interface WriteAccount extends RefWriteAccount {
    /**
     * 
     * @type {WriteAccountProfileProfile}
     * @memberof WriteAccount
     */
    profile?: WriteAccountProfileProfile;
    /**
     * if false, password field is required; otherwise, a 32 char password is generated
     * @type {boolean}
     * @memberof WriteAccount
     */
