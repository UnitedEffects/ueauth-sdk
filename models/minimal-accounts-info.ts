 ...
 */
import { MinimalAccountsInfoInner } from './minimal-accounts-info-inner';
/**
 * 
 * @export
 * @interface MinimalAccountsInfo
 */
export interface MinimalAccountsInfo extends Array<MinimalAccountsInfoInner> {
}
