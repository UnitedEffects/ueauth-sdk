...
export interface Operations {
     ...
     * @memberof Operations
     */
    operation: OperationsOperationEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum OperationsOperationEnum {
    Secret = 'rotate_secret',
    Keys = 'rotate_keys',
    CookieKeys = 'rotate_cookie_keys',
    RegistrationAccessToken = 'rotate_registration_access_token'
}
