 ...
 */
import { GlobalPluginsMfaChallengeProviders } from './global-plugins-mfa-challenge-providers';
/**
 * 
 * @export
 * @interface GlobalPluginsMfaChallenge
 */
export interface GlobalPluginsMfaChallenge {
    /**
     * 
     * @type {boolean}
     * @memberof GlobalPluginsMfaChallenge
     */
    enabled?: boolean;
    /**
     * 
     * @type {Array<GlobalPluginsMfaChallengeProviders>}
     * @memberof GlobalPluginsMfaChallenge
     */
    providers?: Array<GlobalPluginsMfaChallengeProviders>;
}
