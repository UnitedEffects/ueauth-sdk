 ...
 */
import { WriteOrganization } from './write-organization';
 ...
 */
export interface Organization extends WriteOrganization {
    /**
     * 
     * @type {string}
    ...
    active?: boolean;
    /**
     * these are products for which the organization has purchased a license
     * @type {Array<string>}
     * @memberof Organization
     */
