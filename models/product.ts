 ...
 */
import { WriteProduct } from './write-product';
/**
 * 
 * @export
 * @interface Product
 */
export interface Product extends WriteProduct {
    /**
     * unique id of the product - globally unique
     * @type {string}
     * @memberof Product
     */
    id?: string;
    /**
     * this is a 10 character small id that is unique to the authgroup and can be used in place of id
     * @type {string}
     * @memberof Product
     */
    codedId?: string;
