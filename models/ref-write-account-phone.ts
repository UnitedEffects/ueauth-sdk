 ...
 * 
 * @export
 * @interface RefWriteAccountPhone
 */
export interface RefWriteAccountPhone {
    /**
     * used for notifications. only visible to the user in question.
     * @type {string}
     * @memberof RefWriteAccountPhone
     */
    txt?: string;
}
