 ...
 */
import { SecuredProfile } from './secured-profile';
/**
 * Organization User Profiles are unique only to the Organization but reference a single unique Account in the AuthGroup. One Account could have as many Organization User Profiles as there are Organizations to which the Account has been given access.
 * @export
 * @interface OrgUserProfile
 */
export interface OrgUserProfile extends SecuredProfile {
    /**
     * used to associate this Organization User to an internal record of the user in an HCM or other system
     * @type {string}
     * @memberof OrgUserProfile
     */
    externalId?: string;
    /**
     * organization id this profile is associated to
     * @type {string}
     * @memberof OrgUserProfile
     */
    organization?: string;
