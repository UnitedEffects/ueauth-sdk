 ...
 */
import { GlobalPluginsEventStreamProvider } from './global-plugins-event-stream-provider';
/**
 * 
 * @export
 * @interface GlobalPluginsEventStream
 */
export interface GlobalPluginsEventStream {
    /**
     * 
     * @type {boolean}
     * @memberof GlobalPluginsEventStream
     */
    enabled?: boolean;
    /**
     * 
     * @type {GlobalPluginsEventStreamProvider}
     * @memberof GlobalPluginsEventStream
     */
    provider?: GlobalPluginsEventStreamProvider;
}
