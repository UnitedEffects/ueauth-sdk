 ...
 */
import { ValClientAccessAuthGroup } from './val-client-access-auth-group';
/**
 * 
 * @export
 * @interface ValClientAccess
 */
export interface ValClientAccess {
    /**
     * client Id
     * @type {string}
     * @memberof ValClientAccess
     */
    sub?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {ValClientAccessAuthGroup}
     * @memberof ValClientAccess
     */
    authGroup?: ValClientAccessAuthGroup;
    /**
     * 
     * @type {any}
     * @memberof ValClientAccess
