 ...
 */
/**
 * required for the proxy configuration. Do not include for privakey configuration.
 * @export
 * @interface WriteMfaChallengeApi
 */
export interface WriteMfaChallengeApi {
    /**
     * This is the endpoint domain used for your mfa proxy
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    domain?: string;
    /**
     * This is the endpoint path used to send the mfa challenge to the end user
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    challenge?: string;
    /**
     * This is an endpoint path used to validate callback requests from the provider
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    validate?: string;
    /**
     * This is an endpoint path used to map the account ID of the user to the MFA account/device
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    bind?: string;
    /**
     * This is an endpoint path used to return all registered devices of the MFA account
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    devices?: string;
    /**
     * This is an endpoint path used to revoke a device identified by ID of the MFA account
     * @type {string}
     * @memberof WriteMfaChallengeApi
     */
    revoke?: string;
