...
/**
 * the first account on a new auth group activates the group and creates a client
 * @export
 * @interface FirstAccountWrite
 */
export interface FirstAccountWrite {
    /**
     * 
     * @type {string}
     * @memberof FirstAccountWrite
     */
    type?: FirstAccountWriteTypeEnum;
    /**
     * 
     * @type {AccountObject}
     * @memberof FirstAccountWrite
...
/**
    ...
    * @enum {string}
    */
export enum FirstAccountWriteTypeEnum {
    Account = 'Account'
}
