...
export interface InlineResponse20014Data {
    /**
     * the terms that the user has recieved and or accepted
     * @type {any}
     * @memberof InlineResponse20014Data
     */
    terms?: any;
    /**
     * domain information including name and description
     * @type {Array<any>}
     * @memberof InlineResponse20014Data
     */
    domains?: Array<any>;
    ...
    roles?: Array<string>;
    /**
     * details about the organization context of these domains, roles, and terms. This will also include the latest terms of the orgnaization
     * @type {any}
     * @memberof InlineResponse20014Data
     */
    organization?: any;
