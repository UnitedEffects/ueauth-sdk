 ...
 * 
 * @export
 * @interface UserAccessAction
 */
export interface UserAccessAction extends UpdateUserAccess {
    /**
     * organization that action occurred against
     * @type {string}
     * @memberof UserAccessAction
     */
    organization?: string;
    /**
     * what happened
