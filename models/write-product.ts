...
export interface WriteProduct {
    ...
    description?: string;
    /**
     * array of OIDC client Ids that may be associated to this business definition of a product
     * @type {Array<string>}
     * @memberof WriteProduct
     */
    associatedClients?: Array<string>;
    /**
     * if this is true, the product is concidered b2c and it will show up on all user \"my products\" lists
     * @type {boolean}
     * @memberof WriteProduct
     */
    b2c?: boolean;
    ...
    url?: string;
    /**
     * only root users are allowed to set this true
     * @type {boolean}
     * @memberof WriteProduct
     */
    core?: boolean;
    /**
     * optional categorization of the product
     * @type {string}
     * @memberof WriteProduct
     */
    type?: WriteProductTypeEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum WriteProductTypeEnum {
    Global = 'global',
    App = 'app',
    Service = 'service',
    Module = 'module',
