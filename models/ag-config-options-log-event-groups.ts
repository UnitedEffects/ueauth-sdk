 ...
 */
/**
 * these groupings represent events that will either be written to console or streamed (depending on config) when true
 * @export
 * @interface AgConfigOptionsLogEventGroups
 */
export interface AgConfigOptionsLogEventGroups {
    /**
     * 
     * @type {boolean}
     * @memberof AgConfigOptionsLogEventGroups
     */
    general?: boolean;
    /**
     * 
