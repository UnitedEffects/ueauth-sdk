 ...
 * 
 * @export
 * @interface FederatedOAuth2
 */
export interface FederatedOAuth2 extends SsoOAuth2Spec {
    /**
     * 
     * @type {string}
     * @memberof FederatedOAuth2
     */
    provider: FederatedOAuth2ProviderEnum;
    /**
     * 
     * @type {string}
     * @memberof FederatedOAuth2
     */
    buttonType?: FederatedOAuth2ButtonTypeEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum FederatedOAuth2ProviderEnum {
    Linkedin = 'linkedin',
    Custom = 'custom'
}
/**
    ...
    * @enum {string}
    */
export enum FederatedOAuth2ButtonTypeEnum {
    Linkedin = 'linkedin',
    Standard = 'standard'
}
