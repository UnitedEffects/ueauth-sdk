 ...
 * 
 * @export
 * @interface AgConfigOptionsUiSkin
 */
export interface AgConfigOptionsUiSkin {
    /**
     * this is a placeholder for a UI backdrop but is not directly used by this library aside from providing the reference
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    backgroundImage?: string;
    /**
     * this is the splash image used on login and authorization screens. there is a system default
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    splashImage?: string;
    /**
     * a logo for the top of the login and authorize screens. best at 40x40 pixels
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    logo?: string;
    /**
     * a favicon to use with the portal specific to the AG brand. Must be square and no more than 500px
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    favicon?: string;
    /**
     * choose which way the screen inputs are oriented
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    loginOrientation?: AgConfigOptionsUiSkinLoginOrientationEnum;
    /**
     * this is the background color lower end gradient color
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
    bgGradientLow?: string;
    /**
     * this is the background color higher end gradient color
     * @type {string}
     * @memberof AgConfigOptionsUiSkin
     */
...
/**
    ...
    * @enum {string}
    */
export enum AgConfigOptionsUiSkinLoginOrientationEnum {
    Right = 'right',
    Left = 'left',
    Middle = 'middle'
}
