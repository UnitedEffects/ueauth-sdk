 ...
 * 
 * @export
 * @interface SecuredProfile
 */
export interface SecuredProfile extends SecuredProfileWrite {
    /**
     * id of the profile (NOT THE ACCOUNT)
     * @type {string}
     * @memberof SecuredProfile
     */
    id?: string;
    /**
     * reference to the UEAuth Auth Group
     * @type {string}
     * @memberof SecuredProfile
     */
    authGroup?: string;
