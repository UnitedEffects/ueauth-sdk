 ...
 */
import { FederatedOAuth2 } from './federated-oauth2';
import { FederatedOIDC } from './federated-oidc';
import { FederatedSAML } from './federated-saml';
/**
 * 
 * @export
 * @interface AgConfigOptionsFederate
 */
export interface AgConfigOptionsFederate {
    /**
     * 
     * @type {Array<FederatedSAML>}
     * @memberof AgConfigOptionsFederate
     */
    saml?: Array<FederatedSAML>;
    /**
     * 
     * @type {Array<FederatedOIDC>}
     * @memberof AgConfigOptionsFederate
     */
    oidc?: Array<FederatedOIDC>;
    /**
     * 
     * @type {Array<FederatedOAuth2>}
     * @memberof AgConfigOptionsFederate
     */
    oauth2?: Array<FederatedOAuth2>;
}
