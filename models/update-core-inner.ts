 ...
 * 
 * @export
 * @interface UpdateCoreInner
 */
export interface UpdateCoreInner {
    /**
     * This is actually a dynamic property name which will represent your auto-generated Product: Organization Admin Portal
     * @type {any}
     * @memberof UpdateCoreInner
     */
    uEAuthCoreProductName?: any;
}
