 ...
 * 
 * @export
 * @interface SsoOidcSpec
 */
export interface SsoOidcSpec {
    /**
     * unique name to label this federated OIDC connection
     * @type {string}
     * @memberof SsoOidcSpec
     */
    name: string;
    /**
     * 
    ...
    buttonText?: string;
    /**
     * does this OIDC connection require PKCE? Some standard social connections have this and others do not. For example, for Google, this should be false
     * @type {boolean}
     * @memberof SsoOidcSpec
     */
    PKCE?: boolean;
    /**
     * this is the OIDC client id, sometimes referred to as an App ID depending on the platform
     * @type {string}
     * @memberof SsoOidcSpec
     */
    clientId: string;
    /**
     * if you are not using PKCE, this is a required field
     * @type {string}
     * @memberof SsoOidcSpec
     */
    clientSecret?: string;
    ...
    grantType?: string;
    /**
     * this is the discovery oidc .well-known url usually ending in \"/.well-known/openid-configuration\"
     * @type {string}
     * @memberof SsoOidcSpec
     */
    discoveryUrl: string;
    /**
     * UE Auth will automatically request openid and email scopes. You can specificy additional scopes here if required for security
     * @type {Array<string>}
     * @memberof SsoOidcSpec
     */
    scopes?: Array<string>;
