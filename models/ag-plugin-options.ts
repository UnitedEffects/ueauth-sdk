 ...
 */
import { AgPluginOptionsExternalStreaming } from './ag-plugin-options-external-streaming';
import { AgPluginOptionsNotification } from './ag-plugin-options-notification';
import { AgPluginOptionsWebAuthN } from './ag-plugin-options-web-auth-n';
/**
 * these are plugin configurations
 * @export
 * @interface AgPluginOptions
 */
export interface AgPluginOptions {
    /**
     * 
     * @type {AgPluginOptionsWebAuthN}
     * @memberof AgPluginOptions
     */
    webAuthN?: AgPluginOptionsWebAuthN;
    /**
     * 
     * @type {AgPluginOptionsExternalStreaming}
     * @memberof AgPluginOptions
     */
    externalStreaming?: AgPluginOptionsExternalStreaming;
    /**
     * 
     * @type {AgPluginOptionsNotification}
     * @memberof AgPluginOptions
     */
    notification?: AgPluginOptionsNotification;
}
