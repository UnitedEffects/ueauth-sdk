 ...
 */
import { WriteMfaChallengeApi } from './write-mfa-challenge-api';
/**
 * 
 * @export
 * @interface WriteMfaChallenge
 */
export interface WriteMfaChallenge {
    /**
     * 
     * @type {boolean}
     * @memberof WriteMfaChallenge
     */
    enabled: boolean;
    /**
     * 
    ...
    /**
     * must be either 'http-proxy' or 'privakey'. Other options will be added when they are supported.
     * @type {string}
     * @memberof WriteMfaChallenge
     */
    type?: WriteMfaChallengeTypeEnum;
    /**
     * 
     * @type {WriteMfaChallengeApi}
     * @memberof WriteMfaChallenge
     */
    api?: WriteMfaChallengeApi;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum WriteMfaChallengeTypeEnum {
