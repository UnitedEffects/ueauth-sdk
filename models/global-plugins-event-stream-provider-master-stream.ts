 ...
 * @export
 * @interface GlobalPluginsEventStreamProviderMasterStream
 */
export interface GlobalPluginsEventStreamProviderMasterStream {
    /**
     * 
     * @type {boolean}
     * @memberof GlobalPluginsEventStreamProviderMasterStream
     */
    enabled?: boolean;
    /**
     * this is the topic or stream address to publish master stream content
     * @type {string}
     * @memberof GlobalPluginsEventStreamProviderMasterStream
     */
    streamPath?: string;
