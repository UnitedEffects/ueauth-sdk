 ...
 * 
 * @export
 * @interface InlineResponse20012Domains
 */
export interface InlineResponse20012Domains {
    /**
     * how many records matched the account ids given
     * @type {number}
     * @memberof InlineResponse20012Domains
     */
    matching?: number;
    /**
    ...
    modified?: number;
    /**
     * did the update run as expected
     * @type {boolean}
     * @memberof InlineResponse20012Domains
     */
