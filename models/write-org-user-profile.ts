 ...
 */
import { SecuredProfileWrite } from './secured-profile-write';
/**
 * 
 * @export
 * @interface WriteOrgUserProfile
 */
export interface WriteOrgUserProfile extends SecuredProfileWrite {
    /**
     * used to associate this Organization User to an internal record of the user in an HCM or other system
     * @type {string}
     * @memberof WriteOrgUserProfile
     */
    externalId?: string;
}
