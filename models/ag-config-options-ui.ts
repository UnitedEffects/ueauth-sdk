 ...
 */
import { AgConfigOptionsUiSkin } from './ag-config-options-ui-skin';
/**
 * 
 * @export
 * @interface AgConfigOptionsUi
 */
export interface AgConfigOptionsUi {
    /**
     * this object can be used to define customization of any specific UI implementation
     * @type {any}
     * @memberof AgConfigOptionsUi
     */
    meta?: any;
    /**
     * 
     * @type {AgConfigOptionsUiSkin}
     * @memberof AgConfigOptionsUi
     */
    skin?: AgConfigOptionsUiSkin;
}
