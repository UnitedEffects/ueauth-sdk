 ...
 * 
 * @export
 * @interface RefSecuredProfileWriteAdditionalEmails
 */
export interface RefSecuredProfileWriteAdditionalEmails {
    /**
     * 
     * @type {string}
     * @memberof RefSecuredProfileWriteAdditionalEmails
     */
    label?: string;
    /**
     * 
