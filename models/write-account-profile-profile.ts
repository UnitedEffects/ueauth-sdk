 ...
 */
/**
 * These are used to initialize a secured profile. Access is restricted to the Account holder after creation.
 * @export
 * @interface WriteAccountProfileProfile
 */
export interface WriteAccountProfileProfile {
    /**
     * 
     * @type {string}
     * @memberof WriteAccountProfileProfile
     */
    givenName?: string;
    /**
     * 
