 ...
 */
/**
 * privakey plugin specific. NOTE - this is stringified object containing the following
 * @export
 * @interface CallbackRequestTranactionId
 */
export interface CallbackRequestTranactionId {
    /**
     * the interaction id provided by UE Auth - can be interchanged for a generated state as well
     * @type {string}
     * @memberof CallbackRequestTranactionId
     */
    uid?: string;
    /**
     * the account being challenged
     * @type {string}
     * @memberof CallbackRequestTranactionId
     */
    accountId?: string;
