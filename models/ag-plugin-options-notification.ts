 ...
 * 
 * @export
 * @interface AgPluginOptionsNotification
 */
export interface AgPluginOptionsNotification {
    /**
     * allows notifications to be sent from the authgroup
     * @type {boolean}
     * @memberof AgPluginOptionsNotification
     */
    enabled?: boolean;
    /**
     * some notifications are not absolutely required for functionality, if this is false, that functionality will continue and a warning will be sent on notificiation failure. If this is true, the functionality will fail on a notification fail.
     * @type {boolean}
     * @memberof AgPluginOptionsNotification
     */
