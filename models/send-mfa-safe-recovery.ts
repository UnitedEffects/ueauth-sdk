 ...
 * 
 * @export
 * @interface SendMfaSafeRecovery
 */
export interface SendMfaSafeRecovery {
    /**
     * selection determines where the notification will be sent to validate identity
     * @type {string}
     * @memberof SendMfaSafeRecovery
     */
    selection?: SendMfaSafeRecoverySelectionEnum;
    /**
     * must match the state encoded in the access token
     * @type {string}
     * @memberof SendMfaSafeRecovery
     */
    state?: string;
...
/**
    ...
    * @enum {string}
    */
export enum SendMfaSafeRecoverySelectionEnum {
    Email = 'email',
    Device = 'device'
}
