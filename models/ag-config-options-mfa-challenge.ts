 ...
 * 
 * @export
 * @interface AgConfigOptionsMfaChallenge
 */
export interface AgConfigOptionsMfaChallenge {
    /**
     * This enables MFA for the AuthGroup assuming it has been enabled for the Platform
     * @type {boolean}
     * @memberof AgConfigOptionsMfaChallenge
     */
    enable?: boolean;
    /**
     * If this is true, all logins must have MFA enabled and will be onboarded at the first opportunity
     * @type {boolean}
     * @memberof AgConfigOptionsMfaChallenge
     */
    required?: boolean;
    /**
     * This is an indication of the MFA provider and must be the same as what is availble from global plugins
     * @type {string}
     * @memberof AgConfigOptionsMfaChallenge
     */
    type?: AgConfigOptionsMfaChallengeTypeEnum;
    /**
     * This is an area designated for metadata such as provider ids, secrets, etc. As an example, for the privakey integration, use meta to store 'privakeyLoginId', 'privakeyClient' and 'privakeySecret'.
     * @type {any}
     * @memberof AgConfigOptionsMfaChallenge
     */
    meta?: any;
...
/**
    ...
    * @enum {string}
    */
export enum AgConfigOptionsMfaChallengeTypeEnum {
