 ...
 */
import { WriteClientObject } from './write-client-object';
/**
 * this may not be all inclusive, consult the most current oidc specification
 * @export
 * @interface ClientObject
 */
export interface ClientObject extends WriteClientObject {
    /**
     * 
     * @type {Array<string>}
     * @memberof ClientObject
     */
    ...
    clientSecret: string;
    /**
     * the tenant ID (or prettyName) for the authorization group of clients, accounts and oidc configs
     * @type {string}
     * @memberof ClientObject
     */
    authGroup: string;
    /**
     * the oidc spec client access url for api calls
     * @type {string}
     * @memberof ClientObject
     */
    registrationClientUri?: string;
    /**
     * Required to POST or PUT updates to clients if not the authGroup owner. Rotates on each call.
     * @type {string}
     * @memberof ClientObject
     */
