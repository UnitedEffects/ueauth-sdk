 ...
 * 
 * @export
 * @interface ProfileRequestUpdate
 */
export interface ProfileRequestUpdate {
    /**
     * 
     * @type {string}
     * @memberof ProfileRequestUpdate
     */
    action?: ProfileRequestUpdateActionEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum ProfileRequestUpdateActionEnum {
    New = 'new',
    Approved = 'approved',
    Denied = 'denied'
}
