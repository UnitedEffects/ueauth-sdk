 ...
 */
import { RefSecuredProfileWriteAdditionalEmails } from './ref-secured-profile-write-additional-emails';
import { RefSecuredProfileWriteAddress } from './ref-secured-profile-write-address';
import { RefSecuredProfileWriteContactNumbers } from './ref-secured-profile-write-contact-numbers';
/**
 * 
 * @export
 * @interface RefSecuredProfileWrite
 */
export interface RefSecuredProfileWrite {
    /**
     * the User's given name
     * @type {string}
     * @memberof RefSecuredProfileWrite
     */
    givenName?: string;
    /**
     * often the last name or equivalent
     * @type {string}
     * @memberof RefSecuredProfileWrite
     */
    familyName?: string;
    /**
     * preferred display name of the user - sometimes a nickname
     * @type {string}
     * @memberof RefSecuredProfileWrite
     */
    displayName?: string;
    ...
    /**
     * optional block of text about the user
     * @type {string}
     * @memberof RefSecuredProfileWrite
     */
    bio?: string;
    /**
     * URI to an image for profile use
     * @type {string}
     * @memberof RefSecuredProfileWrite
     */
    picture?: string;
    /**
     * 
     * @type {RefSecuredProfileWriteAddress}
     * @memberof RefSecuredProfileWrite
     */
    address?: RefSecuredProfileWriteAddress;
    /**
     * 
     * @type {string}
     * @memberof RefSecuredProfileWrite
    ...
    /**
     * 
     * @type {Array<RefSecuredProfileWriteAdditionalEmails>}
     * @memberof RefSecuredProfileWrite
     */
    additionalEmails?: Array<RefSecuredProfileWriteAdditionalEmails>;
    /**
     * 
     * @type {Array<RefSecuredProfileWriteContactNumbers>}
     * @memberof RefSecuredProfileWrite
     */
    contactNumbers?: Array<RefSecuredProfileWriteContactNumbers>;
}
