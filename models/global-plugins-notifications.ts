 ...
 * 
 * @export
 * @interface GlobalPluginsNotifications
 */
export interface GlobalPluginsNotifications {
    /**
     * 
     * @type {boolean}
     * @memberof GlobalPluginsNotifications
     */
    enabled?: boolean;
    /**
     * the url of your service to which we post
     * @type {string}
     * @memberof GlobalPluginsNotifications
     */
