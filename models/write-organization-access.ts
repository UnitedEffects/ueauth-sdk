 ...
 * 
 * @export
 * @interface WriteOrganizationAccess
 */
export interface WriteOrganizationAccess {
    /**
     * if set to true, users which are added must agree to terms of access
     * @type {boolean}
     * @memberof WriteOrganizationAccess
     */
    required?: boolean;
    /**
     * the terms of access which must be accepted. this should be either a text block or a url
     * @type {string}
     * @memberof WriteOrganizationAccess
     */
    terms?: string;
    /**
     * optional method to version your terms. recommended if you want to update them later
     * @type {string}
     * @memberof WriteOrganizationAccess
     */
    termsVersion?: string;
    /**
     * if this is true, everytime the termsVersion changes, everyone loses access until they accept. Otherwise, a simple notification is created.
     * @type {boolean}
     * @memberof WriteOrganizationAccess
     */
    disableAccessOnChange?: boolean;
}
