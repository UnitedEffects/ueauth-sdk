 ...
 */
/**
 * endpoints for the interface functions
 * @export
 * @interface GlobalPluginsMfaChallengeApi
 */
export interface GlobalPluginsMfaChallengeApi {
    /**
     * This is the domain of your mfa provider proxy
     * @type {string}
     * @memberof GlobalPluginsMfaChallengeApi
     */
    domain?: string;
    /**
