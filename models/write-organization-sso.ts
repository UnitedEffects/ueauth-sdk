 ...
 */
import { SsoOAuth2Spec } from './sso-oauth2-spec';
import { SsoOidcSpec } from './sso-oidc-spec';
import { SsoSamlSpec } from './sso-saml-spec';
/**
 * while the API may define multiple options, you can only ever have one of these at a time on an organization
 * @export
 * @interface WriteOrganizationSso
 */
export interface WriteOrganizationSso {
    /**
     * 
     * @type {SsoSamlSpec}
     * @memberof WriteOrganizationSso
     */
    saml?: SsoSamlSpec;
    /**
     * 
